...
bin/kamal app exec "litestream restore -config /rails/config/litestream.yml -o /tmp/test.sqlite3 storage/production.sqlite3"
bin/kamal app exec "sqlite3 /tmp/test.sqlite3 'SELECT count(*) FROM recipes;'"
```
